...
$linkback = LEPTON_URL.'/modules/members/find_ghosts.php?page_id='.$page_id.'&section_id='.$section_id.'&group_id=1';
...
foreach ($_POST as $value) {
	...
	//delete also all aliases:
		...
		$linkback = ADMIN_URL.'/pages/modify.php?page_id='.$page_id.'&hlmember='.$hlmember;
