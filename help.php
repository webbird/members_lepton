...
if(LANGUAGE_LOADED) {
    $help = LEPTON_PATH."/modules/members/languages/help-EN.php";
    if(file_exists(LEPTON_PATH.'/modules/members/languages/help-'.LANGUAGE.'.php')) {
        $help = LEPTON_PATH."/modules/members/languages/help-".LANGUAGE.".php";
    }
}
