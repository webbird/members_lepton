...
<tr>
  ...
  <tr>
   ...
   <tr>
    <td>[MEMBERPAGE]<br />&nbsp;</td>
    <td>22 ($page_id) -&gt; http://www.mydomain.com/thispage.php (Link to
      internal page, does not break when you move the page)<br />
     Note: [MEMBERPAGE] does NOT contain a link-tag &lt;a href....&gt; see
     {MEMBERPAGE}</td>
  </tr>
    <tr>
    <td>[SORTT]</td>
    ...
    <tr>
      ...
      <td><br />
        ...
        To prevent from empty boxes &lt;div..&gt;&lt;/div&gt; which could cause troubles.</td>
    </tr>
    <tr>
      <td>{GROUPNAME}<br />
      {GROUPDESC}</td>
...
&lt;div class=&quot;member-page&quot;&gt;&lt;a href=&quot;see
[MEMBERPAGE]&quot;&gt; 
Title of the page&lt;/a&gt;&lt;/div&gt; <br />
